...
import com.cygl.scp.exception.command.impl.MediaTypeNotSupportedCommand;
import com.cygl.scp.exception.command.impl.MethodNotSupportedCommand;
import com.cygl.scp.exception.command.impl.MissingParameterCommand;
import com.cygl.scp.exception.command.impl.UnknowCommand;
...
public class ExceptionProcesser {
	...
	/**
	 * 修改删除资源时触发 @Title: handleMethodArgumentNotValidException @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param @param ex @param @return 设定文件 @return
	 * ExceptionResponse 返回类型 @throws
	 */
